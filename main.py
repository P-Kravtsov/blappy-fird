...
game_font_small = pygame.font.Font(FONT_PATH, 30) # Smaller font for messages
...
floor_x_pos = 0
death_message = "" # Variable to hold the message
...
while True:
    ...
    if game_active:
        ...
        # ADDED: Pick a random message, but only once per game over
